...
#>
# build.ps1 - kompiliert apotest.exe (isolierter APO-Test, kein Admin noetig).
...
cl /nologo /O2 /EHsc /std:c++17 /DUNICODE /D_UNICODE /W3 ^
   "$here\apotest.cpp" ^
   /Fe:apotest.exe ^
   /link ole32.lib advapi32.lib legacy_stdio_definitions.lib
"@
